...
describe('[example] binder', () => {
  describe('Table', () => {
    ...
    test('should allow duplicate column names across tables', () => {
      ...
      const analyzeErrors = compiler.analyzeProject(DEFAULT_ENTRY).getErrors();
    ...
    test('should detect duplicate table names within same schema', () => {
      ...
      const compiler = new Compiler();
      compiler.setSource(source);
      const errors = [...compiler.parseFile(DEFAULT_ENTRY).getErrors(), ...compiler.analyzeProject(DEFAULT_ENTRY).getErrors()];
    ...
    test('should handle deeply nested schema names and quoted identifiers', () => {
      ...
      const errors1 = [...compiler1.parseFile(DEFAULT_ENTRY).getErrors(), ...compiler1.analyzeProject(DEFAULT_ENTRY).getErrors()];
      ...
      const errors2 = [...compiler2.parseFile(DEFAULT_ENTRY).getErrors(), ...compiler2.analyzeProject(DEFAULT_ENTRY).getErrors()];
