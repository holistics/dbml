...
import { ElementDeclarationNode, InfixExpressionNode, PostfixExpressionNode, PrefixExpressionNode, PrimaryExpressionNode, ProgramNode, SyntaxNode, TupleExpressionNode, VariableNode } from '@/lib/parser/nodes';
...
import { destructureComplexVariableTuple, extractVarNameFromPrimaryVariable } from '@/lib/analyzer/utils';
import { SymbolKind, createNodeSymbolIndex } from '@/lib/analyzer/symbol/symbolIndex';
import { getSymbolKind } from '@/lib/analyzer/symbol/utils';
import { getElementName, isExpressionAVariableNode } from '@/lib/parser/utils';
