...
import { destructureComplexVariable, destructureMemberAccessExpression } from '@/core/utils';
...
import { createSchemaSymbolIndex } from '@/core/validator/symbol/symbolIndex';
