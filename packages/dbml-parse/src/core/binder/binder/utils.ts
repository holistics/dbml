...
import { destructureComplexVariableTuple, extractVarNameFromPrimaryVariable } from '@/core/binder/utils';
import { SymbolKind, createNodeSymbolIndex } from '@/core/binder/symbol/symbolIndex';
import { getSymbolKind } from '@/core/binder/symbol/utils';
...
import { SymbolToReferencesMap, BinderContext } from '@/core/binder/analyzer';
...
export function lookupAndBindInScope (
  ...
  let curSymbolTable = initialSymbol.symbolTable;
  let curKind = getSymbolKind(initialSymbol);
