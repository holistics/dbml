...
import { SymbolKind, createColumnSymbolIndex } from '@/core/validator/symbol/symbolIndex';
import { destructureComplexVariableTuple, extractVariableFromExpression } from '@/core/utils';
import { TablePartialInjectedColumnSymbol, TablePartialSymbol } from '@/core/validator/symbol/symbols';
