...
import {
  isSimpleName, pickValidator } from '@/core/binder/validator/utils';
import { isValidColor, registerSchemaStack, aggregateSettingList } from '@/core/binder/validator/utils';
import { ElementValidator } from '@/core/binder/validator/types';
...
import { createTableGroupFieldSymbolIndex, createTableGroupSymbolIndex } from '@/core/binder/symbol/symbolIndex';
import { destructureComplexVariable, extractVarNameFromPrimaryVariable } from '@/core/binder/utils';
import { TableGroupFieldSymbol, TableGroupSymbol } from '@/core/binder/symbol/symbols';
