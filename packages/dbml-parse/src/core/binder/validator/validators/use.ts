...
import { isValidName, registerSchemaStack } from '@/core/binder/validator/utils';
import { ExternalSymbol, SchemaSymbol, type NodeSymbol } from '@/core/binder/symbol/symbols';
import { createNodeSymbolIndex, SymbolKind } from '@/core/binder/symbol/symbolIndex';
