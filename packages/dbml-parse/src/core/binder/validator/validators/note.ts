...
import { StickyNoteSymbol } from '@/core/binder/symbol/symbols';
...
import { pickValidator } from '@/core/binder/validator/utils';
import SymbolTable from '@/core/binder/symbol/symbolTable';
import { ElementKind } from '@/core/binder/types';
import { destructureComplexVariable, getElementKind } from '@/core/binder/utils';
import { createStickyNoteSymbolIndex } from '@/core/binder/symbol/symbolIndex';
