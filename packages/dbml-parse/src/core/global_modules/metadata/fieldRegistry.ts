...
// Routing map: one registry entry per target kind. Type erases to <any> here; consumers already do dynamic key lookup.
export const METADATA_FIELDS_BY_KIND: Record<MetadataTargetKind, MetadataFieldRegistry<any, any>> = {
