// True if char is a letter, accent, or underscore
...
// True if char is a decimal digit (0–9)
...
// True if char is a valid hexadecimal digit
...
// True if char is a letter, digit, underscore, or accent
