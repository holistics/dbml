...
describe('lexing', () => {
  ...
  const sourceRegex = new RegExp(
    `^([ ](${numberRegex.source}|${singleLineStringRegex.source}|${multiLineStringRegex.source}|${quotedIdentifierRegex.source}|${functionExpressionRegex.source}|${identifierRegex.source}|${seppuncRegex.source}|${wsRegex.source}|${singleLineCommentRegex.source}|${multiLineCommentRegex.source}|${colorRegex.source}|${opRegex.source}))*\$`,
  );
