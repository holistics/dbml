...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c16 = function(constraint, fields, table2, fields2, onDelete, onUpdate) {
      ...
      peg$c19 = "delete",
      peg$c20 = peg$literalExpectation("DELETE", true),
      peg$c21 = function(action) { return action.toLowerCase() },
      peg$c22 = "update",
      peg$c23 = peg$literalExpectation("UPDATE", true),
      peg$c24 = "unique",
                                          ...
                                          if (s20 !== peg$FAILED) {
                                            ...
                                            if (s21 !== peg$FAILED) {
                                              ...
                                              if (s22 !== peg$FAILED) {
                                                s23 = peg$parse_();
                                                if (s23 !== peg$FAILED) {
                                                  s24 = peg$parseFKOnUpdate();
                                                  if (s24 === peg$FAILED) {
                                                    s24 = null;
                                                  }
                                                  if (s24 !== peg$FAILED) {
                                                    peg$savedPos = s0;
                                                    s1 = peg$c16(s2, s8, s14, s18, s22, s24);
                                                    s0 = s1;
                                                  } else {
                                                    peg$currPos = s0;
                                                    s0 = peg$FAILED;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parse_();
          if (s4 !== peg$FAILED) {
            s5 = peg$parsereferences_options();
            if (s5 !== peg$FAILED) {
              peg$savedPos = s0;
              s1 = peg$c21(s5);
              s0 = s1;
