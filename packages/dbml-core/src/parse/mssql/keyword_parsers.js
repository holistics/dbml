...
exports.KeywordPrimaryKey = keyword(/PRIMARY KEY/i, true);
...
exports.KeywordForeignKey = keyword(/FOREIGN KEY/i, true);
...
exports.KeywordNFR = keyword(/NOT FOR REPLICATION/, true);
exports.KeywordOnDelete = keyword(/ON DELETE/i, true);
exports.KeywordOnUpdate = keyword(/ON UPDATE/i, true);
exports.KeywordSetNull = keyword(/SET NULL/i, true);
exports.KeywordSetDefault = keyword(/SET DEFAULT/i, true);
exports.KeywordNoAction = keyword(/NO ACTION/i, true);
...
exports.KeywordNotNull = keyword(/NOT NULL/i, true);
...
exports.KeywordGeneratedAAR = keyword(/GENERATED ALWAYS AS ROW/i, true);
...
exports.KeywordPeriodForST = keyword(/PERIOD FOR SYSTEM_TIME/i, true);
...
exports.KeywordColumnSet = keyword(/XML COLUMN_SET FOR ALL_SPARSE_COLUMNS/i, true);
...
exports.KeywordWithValues = keyword(/WITH VALUES/i, true);
...
exports.KeywordAlterColumn = keyword(/ALTER COLUMN/i, true);
exports.KeywordGo = keyword(/GO/i);
exports.KeywordDrop = keyword(/DROP/i);
exports.KeywordBulkInsert = keyword(/BULK INSERT/i, true);
exports.KeywordInsert = keyword(/INSERT/i);
exports.KeywordUpdate = keyword(/UPDATE/i);
exports.KeywordMerge = keyword(/MERGE/i);
exports.KeywordTruncateTable = keyword(/TRUNCATE TABLE/i, true);
