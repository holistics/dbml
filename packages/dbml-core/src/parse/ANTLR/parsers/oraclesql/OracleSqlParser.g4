/*
Original: https://github.com/antlr/grammars-v4/blob/master/sql/plsql/PlSqlParser.g4
...
parser grammar OracleSqlParser;

options {
    tokenVocab = OracleSqlLexer;
    superClass = OracleSqlParserBase;
}
