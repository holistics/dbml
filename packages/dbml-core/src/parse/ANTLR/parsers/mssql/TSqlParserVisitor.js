...
export default class TSqlParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitBatch_level_statement(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitFile_directory_path_separator(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitDelete_statement_from(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitUpdate_statistics_options(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by TSqlParser#update_statistics_option.
	visitUpdate_statistics_option(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitTarget_recovery_time_option(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by TSqlParser#termination.
	visitTermination(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitDrop_relational_or_xml_or_spatial_index(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by TSqlParser#drop_backward_compatible_index.
	visitDrop_backward_compatible_index(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitRowset_function_limited(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitExecute_statement_arg_unnamed(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitSelect_order_by_clause(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitMIN_ACTIVE_ROWVERSION(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitDatabase_filestream_option(ctx) {
	  return this.visitChildren(ctx);
	}
