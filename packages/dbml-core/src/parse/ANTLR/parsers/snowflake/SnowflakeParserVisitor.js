...
export default class SnowflakeParserVisitor extends antlr4.tree.ParseTreeVisitor {
  ...
  visitTruncate_materialized_view (ctx) {
	  return this.visitChildren(ctx);
  }
  ...
  visitArg_default_value_clause (ctx) {
	  return this.visitChildren(ctx);
  }
  ...
  visitStage_encryption_opts_internal (ctx) {
	  return this.visitChildren(ctx);
  }
  ...
  visitWith_row_access_policy (ctx) {
	  return this.visitChildren(ctx);
  }
  ...
  visitCreate_table_as_select (ctx) {
	  return this.visitChildren(ctx);
  }
  ...
  visitDrop_row_access_policy (ctx) {
	  return this.visitChildren(ctx);
  }
  ...
  visitColumn_list_with_comment (ctx) {
	  return this.visitChildren(ctx);
  }
  ...
  visitObject_name_or_identifier (ctx) {
	  return this.visitChildren(ctx);
  }
