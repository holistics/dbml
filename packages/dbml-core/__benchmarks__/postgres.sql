...
CREATE TABLE person.person (
    ...
    namestyle "NameStyle" DEFAULT false NOT NULL,
...
CREATE TABLE person.stateprovince (
    ...
    countryregioncode character varying(3) NOT NULL,
    isonlystateprovinceflag "Flag" DEFAULT true NOT NULL,
    name "Name" NOT NULL,
...
CREATE TABLE production.document (
    ...
    folderflag "Flag" DEFAULT false NOT NULL,
    ...
    rowguid uuid DEFAULT uuid_generate_v1() NOT NULL,
    modifieddate timestamp without time zone DEFAULT now() NOT NULL,
    documentnode character varying DEFAULT '/',
...
CREATE TABLE production.product (
    ...
    makeflag "Flag" DEFAULT true NOT NULL,
    finishedgoodsflag "Flag" DEFAULT true NOT NULL,
...
CREATE TABLE production.productproductphoto (
    productid integer NOT NULL,
    productphotoid integer NOT NULL,
    "primary" "Flag" DEFAULT false NOT NULL,
    modifieddate timestamp without time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE purchasing.vendor (
    ...
    preferredvendorstatus "Flag" DEFAULT true NOT NULL,
    activeflag "Flag" DEFAULT true NOT NULL,
...
CREATE TABLE sales.salesorderheader (
    ...
    shipdate timestamp without time zone,
    status smallint DEFAULT 1 NOT NULL,
    onlineorderflag "Flag" DEFAULT true NOT NULL,
