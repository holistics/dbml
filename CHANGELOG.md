...
* `dbml-cli`, `dbml-core`, `dbml-parse`
  * [#870](https://github.com/holistics/dbml/pull/870) DBX-6700 Query-based compiler & Multifile support ([@huydo862003](https://github.com/huydo862003))
...
* `dbml-core`
  * [#870](https://github.com/holistics/dbml/pull/870) `Parser` constructor no longer accepts a compiler — it creates its own `MemoryProjectLayout` and `Compiler` internally. Access the internal compiler via `parser.DBMLCompiler`. (Low impact — no apps currently pass a compiler) ([@huydo862003](https://github.com/huydo862003))
  * [#870](https://github.com/holistics/dbml/pull/870) `Parser.parseDBMLToJSONv2` no longer accepts a compiler parameter. (Low impact — no apps currently use this parameter) ([@huydo862003](https://github.com/huydo862003))
* `dbml-parse`
  * [#870](https://github.com/holistics/dbml/pull/870) Language services now require `TextModel` URIs to be set — multifile support means the compiler identifies files by URI. Use `DEFAULT_ENTRY` from `@dbml/parse` for single-file apps. (Medium impact — breaks dbdiagram and runsql language services) ([@huydo862003](https://github.com/huydo862003))
