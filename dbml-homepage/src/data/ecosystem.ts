...
export interface EcosystemItem {
  ...
  author?: string;
  /**
   * Short caveat shown under the description — used to flag projects with no
   * commits in over two years. Activity was last checked 2026-09-08.
   */
  note?: string;
...
export const communityProjects: EcosystemItem[] = [
  ...
  },
  {
    ...
    language: 'Python',
    author: 'hamedsj',
    note: 'No commits since May 2022 — django-dbml is actively maintained.',
  ...
  {
    name: 'dbml-rs',
    description: 'DBML parser for Rust.',
    href: 'https://github.com/apskhem/dbml-rs',
    repo: 'apskhem/dbml-rs',
    language: 'Rust',
    author: 'apskhem',
    categories: ['parser'],
  },
  {
    name: 'lark-dbml',
    description:
      'DBML parser built on Lark, with Pydantic models and structured output for Python.',
    href: 'https://github.com/daihuynh/lark-dbml',
    repo: 'daihuynh/lark-dbml',
    language: 'Python',
    author: 'daihuynh',
    categories: ['parser'],
  },
  {
    name: 'dbml-ruby',
    description: 'Ruby library for reading DBML.',
    href: 'https://github.com/simonwo/dbml-ruby',
    repo: 'simonwo/dbml-ruby',
    language: 'Ruby',
    author: 'simonwo',
    note: 'No commits since March 2021.',
    categories: ['parser'],
  },
  {
    name: 'db-schema-visualizer',
    description:
      'VS Code extension that renders a DBML or Prisma file as an entity-relationship diagram.',
    href: 'https://github.com/BOCOVO/db-schema-visualizer',
    repo: 'BOCOVO/db-schema-visualizer',
    language: 'TypeScript',
    author: 'BOCOVO',
    categories: ['editor'],
  },
  {
    name: 'dbml-editor',
    description: 'Free, open-source DBML editor that runs in the browser.',
    href: 'https://github.com/alswl/dbml-editor',
    repo: 'alswl/dbml-editor',
    language: 'TypeScript',
    author: 'alswl',
    categories: ['editor'],
  },
  {
    name: 'vscode-dbml-previewer',
    description: 'Preview DBML diagrams inside Visual Studio Code.',
    href: 'https://github.com/kykurniawan/vscode-dbml-previewer',
    repo: 'kykurniawan/vscode-dbml-previewer',
    language: 'JavaScript',
    author: 'kykurniawan',
    categories: ['editor'],
  },
  {
    ...
    description: 'Obsidian plugin that renders dbml code blocks as ER diagrams in your notes.',
    href: 'https://github.com/wrojasa/obsidian-dbml-erd',
  ...
  {
    name: 'dbml-formatter',
    description: 'Opinionated formatter for DBML files.',
    href: 'https://github.com/idoaflalo/dbml-formatter',
    repo: 'idoaflalo/dbml-formatter',
    language: 'JavaScript',
    author: 'idoaflalo',
    categories: ['editor'],
  },
  {
    name: 'dbterd',
    description:
      'Turn dbt artifacts into ER diagrams, with DBML as one of the output targets.',
    href: 'https://github.com/datnguye/dbterd',
    repo: 'datnguye/dbterd',
    language: 'Python',
    author: 'datnguye',
    categories: ['to-dbml'],
  },
  {
    ...
    description: 'Generate DBML from a schema defined with Drizzle ORM.',
    href: 'https://github.com/L-Mario564/drizzle-dbml-generator',
    repo: 'L-Mario564/drizzle-dbml-generator',
    language: 'TypeScript',
    author: 'L-Mario564',
    categories: ['to-dbml'],
  },
  {
    ...
    description: 'CLI that generates DBML or markdown documentation from Drizzle ORM schemas.',
    href: 'https://github.com/rikeda71/drizzle-docs-generator',
    repo: 'rikeda71/drizzle-docs-generator',
    language: 'TypeScript',
    author: 'rikeda71',
    categories: ['to-dbml'],
  },
  {
    name: 'django-dbml',
    description: 'Generate DBML for every installed Django model.',
    href: 'https://github.com/makecodes/django-dbml',
    repo: 'makecodes/django-dbml',
    language: 'Python',
    author: 'makecodes',
    categories: ['to-dbml'],
  },
  {
    name: 'pg_dbml',
    description:
      'CLI that exports a PostgreSQL schema to DBML using pure SQL introspection.',
    href: 'https://github.com/heptau/pg_dbml',
    repo: 'heptau/pg_dbml',
    language: 'Shell',
    author: 'heptau',
    categories: ['to-dbml'],
  ...
  {
    name: 'Kludex/dbml',
    description: 'Convert SQLAlchemy and SQLModel definitions to DBML, and back again.',
    href: 'https://github.com/Kludex/dbml',
    repo: 'Kludex/dbml',
    language: 'Python',
    author: 'Kludex',
    note: 'No commits since December 2022.',
    categories: ['to-dbml', 'from-dbml'],
  },
  {
    name: 'dbml-to-laravel',
    description:
      'Laravel package that generates Eloquent models and migration files from a DBML schema.',
    href: 'https://github.com/egyjs/dbml-to-laravel',
    repo: 'egyjs/dbml-to-laravel',
    language: 'JavaScript',
    author: 'egyjs',
    categories: ['from-dbml'],
  },
  {
    name: 'mkdocs-dbml',
    description:
      'MkDocs plugin that renders DBML as interactive ER diagrams with drag, zoom and export.',
    href: 'https://github.com/ZhuchkaTriplesix/mkdocs-dbml',
    repo: 'ZhuchkaTriplesix/mkdocs-dbml',
    language: 'Python',
  ...
  {
    name: 'DBMLDocs',
    description: 'Standalone site that renders database documentation from DBML files.',
    href: 'https://github.com/IllusiveBagel/DBMLDocs',
    repo: 'IllusiveBagel/DBMLDocs',
    language: 'TypeScript',
    author: 'IllusiveBagel',
    categories: ['from-dbml'],
  },
  {
    name: 'DBML_SQLite',
    description: 'Python package that generates SQLite DDL from DBML.',
    href: 'https://github.com/dvanderweele/DBML_SQLite',
    repo: 'dvanderweele/DBML_SQLite',
    language: 'Python',
    author: 'dvanderweele',
    categories: ['from-dbml'],
  },
  {
    name: 'dbml2puml',
    description: 'Read a DBML file and output a PlantUML diagram.',
    href: 'https://github.com/rscoopcur/dbml2puml',
    repo: 'rscoopcur/dbml2puml',
    language: 'TypeScript',
    author: 'rscoopcur',
    note: 'No commits since February 2022.',
    categories: ['from-dbml'],
  },
  {
    name: 'dbml2dot',
    description: 'Convert DBML files to Graphviz .dot format.',
    href: 'https://github.com/aviallon/dbml2dot',
    repo: 'aviallon/dbml2dot',
    language: 'Python',
    author: 'aviallon',
    note: 'No commits since March 2021.',
    categories: ['from-dbml'],
